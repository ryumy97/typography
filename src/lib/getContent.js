    ...
    switch (number) {
        ...
        case 4:
            return {
                ...
                number,
                description:
                    '2-bit particle texture. User has ability to create a projectile that interacts with the surface.',
        ...
        case 7:
            return {
                ...
                number,
                description:
                    'Glowing particles to form letters. Each particle is free to roaming around in a bouding area.',
